...
var dataService = /** @class */ (function () {
    function dataService(http) {
        this.http = http;
        this.apiKey = 'f7879ce630d05897fa0b0587217b0d68';
        this.reports = [];
    ...
    dataService.prototype.errorHandler = function (err) {
        return rxjs_internal_Observable__WEBPACK_IMPORTED_MODULE_3__["Observable"].throw("city not found");
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(weather) {
        ...
        this.cityCards = this.weather.reports;
    }
    // Add a city to the display home screen
    HomeComponent.prototype.onAddCity = function () {
        var _this = this;
        ...
        if (this.search(this.weather.reports, city) || this.search(this.weather.reports, city) === 0) {
            ...
            this.weather.getWeather(city).subscribe(function (res) { return _this.weather.reports.push(res); }, function (error) { return _this.errorMessage = "City not found"; });
        }
    };
    // search for if a city in the reports, returns true or false
    HomeComponent.prototype.search = function (arr, city) {
        var i = 0;
        while (i < arr.length) {
    ...
    HomeComponent.prototype.onUpdate = function (e) {
        var _this = this;
        console.log(e);
        // get the city index in the current array of reports
        var indexOfCity = this.search(this.weather.reports, e);
        // subscribe and replace the new response with the old // no need to handle an error
        this.weather.getWeather(e).subscribe(function (res) { return _this.weather.reports.splice(indexOfCity, 1, res); });
    };
    HomeComponent.prototype.onDelete = function (e) {
        var indexOfCity = this.search(this.weather.reports, e);
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(weather) {
        this.weather = weather;
    }
...
module.exports = __webpack_require__(/*! C:\Users\danom\Desktop\FED Projects\Angular\weatherapp\src\main.ts */"./src/main.ts");
